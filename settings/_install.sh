...
sudo apt install -y \
    ...
    fakeroot simple-scan screen picocom nmap lsof arp-scan lsscsi gddrescue gdebi-core cifs-utils nfs-common tmux screenfetch snapd docker-ce  `# system utilities` \
